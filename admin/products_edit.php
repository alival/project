...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if ($_FILES['image']['tmp_name'] != '') {
		...
		$addProduct->main_image = $product['main_image'];
...
<div class="content">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<img src="../images/products/<?php echo $product['main_image']?>" width="100"><a href="products_edit.php?id=<?=$product['id'] ?>&action=delete" style="position: absolute;">[X]</a>
		<br>
		<?php } ?>
		<label>
