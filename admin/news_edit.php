...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	$addNew->content = htmlspecialchars($content);
...
<div class="content">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<img src="../images/news/<?php echo $news['image']?>" width="100"><a href="news_edit.php?id=<?=$news['id'] ?>&action=delete" style="position: absolute;">[X]</a>
		<br>
		<?php } ?>
		<label>
